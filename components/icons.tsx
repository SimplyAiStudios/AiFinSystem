...
export const ServerCrashIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M6 22h12"/>
        <path d="M12 18v-4"/>
        <path d="M4.4 7.4A9 9 0 0 1 20.5 11"/>
        <path d="M12 2a10 10 0 0 0-9.4 6.4"/>
        <path d="m20.5 7.4-4.5 3.6"/>
        <path d="m3.5 11 4.5-3.6"/>
    </svg>
);
